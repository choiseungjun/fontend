...
### 27. HTML5 주요 특징
    ...
    1. 시맨틱 : 구조에 의미를 부여하는 시맨틱은 보다 다양한 기능의 HTML 태그를 제공합니다.
    2. 멀티미디어 : 플러그인 기반의 각종 프로그램을 별도로 설치하지 않아도 영상, 음악 지원 기능을 자체적으로 제공합니다.
    3. 오프라인과 저장소(스토리지) : 인터넷 연결이 지원되지 않는 곳에서도 웹 이용을 가능하게 하는 오프라인 처리 기능과 로컬 저장소, DB 및 파일 액세스 처리가 가능합니다.
    4. CSS3 효과 : 기존 웹 문서의 성능에 엽향을 주지 않으면서 웹 애플리케이션의 UI(스타일 효과 등) 기능을 강화하였습니다.
    5. 글꼴 효과 : 웹 공개 글꼴 형식(WOFF)를 통해 더욱 다양한 글꼴을 제공합니다.
    6. 3D, 그래픽 효과 : SVC, 캔버스, WebGL 기능을 통해 다양한 시각효과(2차원, 3차원 그래픽)효과를 제공합니다.
